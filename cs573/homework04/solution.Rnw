...
<<p2a, fig.pos="h", fig.height=5, echo=FALSE, fig.cap="Comparison of estimates over 1000 iterations">>=
plotPartA <- function () {
    plot(R, beta0,
         type = "l",
...
<<p2b, fig.pos="h", fig.height=5, fig.cap="Comparison of estimates over 1000 iterations">>=
...
<<p2c, echo=FALSE, fig.pos="h", fig.height=4, fig.cap="Differences between current and previous estimate">>=
plot(R, beta0.diff,
     type = "l",
     xlab = "Iteration",
     ylab = "Difference",
