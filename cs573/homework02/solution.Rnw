...
@
    ...
    Giving us the fraction of: \((0 + 61)/(0 + 43 + 0 + 61) = 0.587\).
    \\
...
<<>>=
manova.qda <- manova(formula = Direction ~ Lag2, data = Weekly.train)
summary(manova.qda, test="Wilks")
@
...
@
    Giving us the fraction of: \((21 + 31)/(21 + 30 + 22 + 31) = 0.500\).
    \\
