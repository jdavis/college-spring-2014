...
<<pII, fig.pos="H", fig.height=5, fig.cap="Part II plot.", dev="png">>=
pairs(college[,1:10])
@
...
<<pIII, fig.pos="H", fig.height=4, fig.cap="Part III plot.">>=
...
<<pIV, fig.pos="H", fig.height=4, fig.cap="Part IV plot.">>=
