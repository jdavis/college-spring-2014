...
\begin{homeworkProblem}
    ...
    Instead of answering the book questions, make a table of theoretical
    values versus simluation values for these quantities:
    \[
        r, \pi_0, \pi_1, \pi_2, \sum_{k = 3}^{\infty} \pi_k,
        \E[X], \Var[X], \E[X_s], \E[X_w], \E[R], \E[S], \E[W]
    \]
