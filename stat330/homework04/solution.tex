...
\begin{homeworkProblem}
    ...
    \[
        \begin{split}
            \Pr(E \mid R) \dist{Poisson}(10) = p(8) &= e^{-10}\frac{10^8}{8!} \approx .113
            \\
            \Pr(E \mid \overline{R}) \dist{Poisson}(4) = p(8) &= e^{-4}\frac{4^8}{8!} \approx .030
        \end{split}
    \]
...
\begin{homeworkProblem}
    ...
    or \(P[X > 15]\). This gives:
    \\

    \[
        P[X > 15] = 1 - P[X < 15] = 1 - (1 - p)^{15} = 1 - (.854)^{15} \approx .0937
    \]
...
\begin{homeworkProblem}
    ...
    Let \(X\) be the number of earthquakes in Alaska. This problem takes the
    form of the Poisson distribution. We have a rate and a value that has one
    of the units of the rate. Thus we can calculate our lambda, \(\lambda = (12
    / 10) (3) = 3.6\) occurences (earthquakes).
    \\
...
\begin{homeworkProblem}
    ...
    Let \(X\) be the number of blemishes on the paper. This problem takes the
    form of the Poisson distribution. We have a rate and a value that has one
    of the units of the rate. Thus we can calculate our lambda, \(\lambda =
    (1.5) (0.4) = .6\) occurences (blemishes).
    \\
...
\begin{homeworkProblem}
    ...
    Let \(X\) be the number of 30 lectures you miss. If we think about attend
    as a success and missing lecture as a failure, then this takes the form of
