...
\begin{homeworkProblem}
    ...
    Let \(S_n = X_1 + X_1 + \cdots + X_n\). Given this, we know that using the
...
@
    ...
    Thus the probability was \(\Sexpr{H/N}\) which means that \(\Sexpr{H}\) found
    their way home and the rest died.
