...
\begin{homeworkProblem}
    ...
    Since events \(G\) and \(H\) are disjoint, \(G \cup H\) constitutes a new
    event that includes outcomes in \(G\) or in \(H\).
    \\
    ...
    A new event that includes the outcomes that happen in \textbf{both} event
    \(G\) and event \(H\).
    \\
