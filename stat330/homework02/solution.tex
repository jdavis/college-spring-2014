...
\begin{homeworkProblem}
    ...
    \(\Pr(B) > 0\). Show that \(\overline{A}\) and \(B\) are also independent.
    \\

    \solution

    We know that \(A\) and \(B\) are events with probability \(\Pr(A) > 0\) and
    \(\Pr(B) > 0\). The events are also independent, which means that \(\Pr(A
    \cap B) = \Pr(A) \Pr(B)\).
    \\

    We want to show that \(\overline{A}\) and \(\overline{B}\) are independent
    which will mean that \(\Pr(\overline{A} \cap \overline{B}) =
...
\begin{homeworkProblem}
    ...
    \[
            \begin{split}
                \Pr(\overline{A} \mid B) &=
                \\
                &= \frac{\Pr(B \mid \overline{A}) \Pr(\overline{A})}{\Pr(B)}
                \\
                &= \frac{
