...
\begin{homeworkProblem}
    ...
    probability is 0.9861. This represents the \(z_{\alpha / 2}\) probability
    however.  This means that the \(\alpha\) that we found is twice the value
    of ours. This gives us the value of \(\frac{\alpha}{2} = 1 - 0.9861 =
    0.0139\). Thus \(\alpha = 0.0278\). We know that \(1 - \alpha\) gives our
    probability, thus \(1 - 0.0278 = 97.22\%\) is the probability that we are
    looking for.
\end{homeworkProblem}
