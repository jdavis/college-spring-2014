...
\begin{homeworkProblem}
    ...
    The problem description gives us \(\lambda = .5\) and \(t\) is the interval
    size. We want the probability that less than 2 jobs arrive, or \(P(X <
    2)\).
    \\
...
\begin{homeworkProblem}
    ...
    We are looking for \(P(Z < c) = .05\). Using the table, we know that \(c =
...
\begin{homeworkProblem}
    ...
    7 inches (79 inches), and the standard deviation is 3.89 inches. Assuming Normal
